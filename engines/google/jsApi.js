...
if (!window['google']['loader']) {
    ...
    (function () {
        ...
        google.load = function (a, b, c) {
            function d(a) {
                var b = a.split(".");
                if (2 < b.length) throw D("Module: '" + a + "' not found!");
            ...
            if (a = G[":" + e]) {
                ...
                if ((f = c && null != c.callback) && !a.D(b)) throw D("Module: '" + e + "' must be loaded before DOM onLoad!");
                f ? a.u(b, c) ? window.setTimeout(c.callback, 0) : a.load(b, c) : a.u(b, c) || a.load(b, c)
            } else throw D("Module: '" + e + "' not found!");
        };
        ...
        google.loader.f = function (a, b, c) {
            a: {
                var d = g.document;
                if ((d = d.querySelector && d.querySelector("script[nonce]")) && (d = d.nonce || d.getAttribute("nonce")) && x.test(d)) break a;d = void 0
            }
            if (c) {
                if ("script" == a) {
                ...
                a.appendChild(e)
            } else "script" == a ? (e = '<script src="' + w(b) + '" type="text/javascript"', d && (e += ' nonce="' + w(d) + '"'), document.write(e + ">\x3c/script>")) : "css" == a && (e = '<link href="' + w(b) + '" type="text/css" rel="stylesheet"', d && (e += ' nonce="' + w(d) + '"'), document.write(e + "></link>"))
        };
        ...
        google.loader.ba = function (a) {
            for (var b in a) "string" == typeof b && b && ":" == b.charAt(0) && !G[b] && (G[b] = new O(b.substring(1), a[b]))
        };
        ...
        P.prototype.load = function (a, b) {
            ...
            if (c.length) {
                ...
                if (b || null == H[":" + this.b] || null == H[":" + this.b].versions[":" + a] || google.loader.AdditionalParams || !this.s) b && b.autoloaded || google.loader.f("script", this.i(a,
                    b), d);
                else {
                    a = H[":" + this.b];
        ...
        O.prototype.i = function (a, b) {
            if (!this.h.versions[":" + a]) {
                ...
                if (!this.h.versions[":" + a]) throw D("Module: '" + this.b + "' with version '" + a + "' not found!");
            }
    ...
    google.loader.rfm({
        ":search": {
            ...
            "path": "/api/search/1.0/76c37a052829ad2c9825658fbbc50bce/",
            "js": "default+en_GB.I.js",
            "css": "default+en_GB.css",
            "properties": {
                ":Version": "1.0",
                ":NoOldNames": false,
                ":JSHash": "76c37a052829ad2c9825658fbbc50bce"
            }
        },
        ":language": {
            "versions": {
            ...
            "path": "/api/language/1.0/56fdcd67fffdfab0d072a8ac4d438ab3/",
            "js": "default+en_GB.I.js",
            "properties": {
                ":Version": "1.0",
                ":JSHash": "56fdcd67fffdfab0d072a8ac4d438ab3"
            }
        },
        ":annotations": {
            "versions": {
